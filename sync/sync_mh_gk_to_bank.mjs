...
const TEST_SERIES_SLUG = "maharashtra-general-knowledge";
const TEST_SERIES_ID = "620f8e54ac7f5636426caddc";
    ...
    try {
        ...
        for (const qSec of qSections) {
            for (const qItem of qSec.questions || []) {
                ...
                const subjectName = globalConcept?.s?.title || secName || "General Knowledge";
...
async function main() {
    ...
    console.log(`\n==================================================`);
    console.log(`🎉 SUCCESS! Completed Maharashtra General Knowledge import into BANK Database! Total questions processed: ${totalQuestionsInserted}`);
