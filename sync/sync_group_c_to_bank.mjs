...
const TEST_SERIES_SLUG = "mpsc-group-c";
const TEST_SERIES_ID = "6a3d28244deef418ada5989f";
...
async function main() {
    ...
    console.log(`\n==================================================`);
    console.log(`🎉 SUCCESS! Completed MPSC Group C import into BANK Database! Total questions processed: ${totalQuestionsInserted}`);
