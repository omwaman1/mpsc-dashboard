<?php
// sync/config.php - Direct Database Connection Configuration
error_reporting(0);
...
if (!defined('RAZORPAY_PAYMENT_URL')) define('RAZORPAY_PAYMENT_URL', 'https://rzp.io/rzp/FTFoJWx'); // Razorpay payment link or page URL
