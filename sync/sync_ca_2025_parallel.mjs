...
const SLUG = "ssc-railways-current-affairs";
const CONCURRENCY = 8;
...
async function processSingleTest(testObj, index, total) {
    ...
    const categoryName = "Current Affairs Mega Pack (2025-26)";
    const subjectName = subSectionName || "General Knowledge";
    const topicName = sectionName || "Current Affairs";
...
async function main() {
    console.log("=================================================");
    console.log("=== CURRENT AFFAIRS 2025 MEGA PACK PARALLEL SYNC ===");
    console.log("=================================================\n");

    const db = getPool();

    console.log("Fetching test structure for Current Affairs 2025 Mega Pack...");
    ...
    if (testsToSync.length === 0) {
        console.log("All Current Affairs 2025 Mega Pack test papers are already fully synced!");
        process.exit(0);
    }
    ...
    console.log("=================================================");
    console.log("=== CURRENT AFFAIRS 2025 MEGA PACK SYNC COMPLETE ===");
...
main().catch((err) => {
    console.error("FATAL ERROR in CA 2025 sync:", err);
    process.exit(1);
});
